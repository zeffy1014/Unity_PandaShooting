...
// 各種Eventをフックして使う
public class EventTriggerExtention : EventTrigger
{
    public override void OnPointerDown(PointerEventData data)
    {
        Debug.Log("OnPointerDown called.");
        this.GetComponent<ButtonOperation>().OnButtonDown(data);
    }

    public override void OnPointerUp(PointerEventData data)
    {
        Debug.Log("OnPointerUp called.");
        this.GetComponent<ButtonOperation>().OnButtonUp(data);
    }

    public override void OnBeginDrag(PointerEventData data)
    {
        Debug.Log("OnBeginDrag called.");
        this.GetComponent<ButtonOperation>().OnStartDrag(data);
    }

    public override void OnEndDrag(PointerEventData data)
    {
        Debug.Log("OnEndDrag called.");
        this.GetComponent<ButtonOperation>().OnEndDrag(data);
    }

    // 以下は現状で使用しないのでoverrideなし
    /*
